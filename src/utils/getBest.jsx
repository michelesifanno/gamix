  ...
  useEffect(() => {
    async function getData() {
      ...
      try {
        ...
        const response = await fetch(`${import.meta.env.VITE_BASE_URL}games?key=${import.meta.env.VITE_API_KEY}&page_size=15&ordering=-rating&page=${page}`);
